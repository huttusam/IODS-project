...
Presenting and interpreting a summary of the fitted model.
...
Presenting and interpreting the coefficients of the model as odds ratios and providing confidence intervals for them.
```{r echo=FALSE, error=FALSE, warning=FALSE, message=FALSE}
...
###Tabultation of predictions vs. actual values
