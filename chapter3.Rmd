...
##### I have created a new dataset named 'alcohol-joined' from the datasets 'student-mat' and 'students-por'.  

##### Data Files:  
* The original datasets are here:
[student-mat.csv](https://github.com/huttusam/IODS-project/blob/master/data/student-mat.csv)  
[student-por.csv](https://github.com/huttusam/IODS-project/blob/master/data/student-por.csv)  

* The new dataset (alcohol-joined.csv) can be found [here](https://github.com/huttusam/IODS-project/blob/master/data/alcohol-joines.csv)  

##### Script:  
* The R script used to create the new dataset (*with comments explaining the process*) is  [here](https://github.com/huttusam/IODS-project/blob/master/data/create_alc.R)  
