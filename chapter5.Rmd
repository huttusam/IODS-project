...
Next, we'll load the 'tea' dataset from the Factominer package and look at the structure and the dimensions of the data:  
...
summary(tea)
```
Then we'll take some of the 'tea' data columns and visualize them:  
```{r echo=FALSE, error=FALSE, warning=FALSE, message=FALSE}
