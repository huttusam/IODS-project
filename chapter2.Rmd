...
From these results, we can see that the combination of *attitude* and *stra* explain exam result on a statistically significant level. On the other hand, *attitude* as the only explanatory variable, explains the dependant variable even better, as we can see here:
